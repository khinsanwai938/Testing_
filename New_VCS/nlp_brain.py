...
class DroneNLPEngine:
    def __init__(self):
        ...
        self.command_dictionary = {
            ...
            "set_fbwa": [
                "fly by wire", "fbwa", "fly by wire a", "fly by wire alpha",
            ],
            "set_auto": [
            ...
            "set_manual": [
                "manual mode", "switch to manual", "full manual control",
            ],
            "start_mission": [
                "start mission", "begin mission", "run mission",
                "execute waypoints", "start the mission",
            ],
